 ...
 $(selector).datepick({minDate: 0, maxDate: '+1m +1w'}) */
	$.JQPlugin.createPlugin({
		...
		defaultRenderer: {
			...
			month: '<div class="datepick-month"><div class="datepick-month-header"><div class="pageprev">{link:prevDay}{link:prev}{link:prevJump}</div>{monthHeader}<div class="page">{link:nextDay}{link:next}{link:nextJump}</div></div>' +
 ...
 $(selector).datepick('setDate', [date1, date2, date3]) */
		...
		selectDate: function(elem, target) {
			...
			if (!$.isEmptyObject(inst) && !this.isDisabled(elem)) {
                ...
                console.log(inst.selectedDates)
		...
		_generateMonthSelection: function(inst, year, month, minDate, maxDate, monthHeader) {
			...
			//	}
			//}
			//selector += '</select><span style="width: auto; padding:0; display: inline;">月</span>';


            var selector = '';
            selector += '<span style="width: auto; padding:0; display: inline-block; line-height: 32px;font-size: 16px;"><i id="nowmonth">'+month+'</i>月</span>';
			...
			if (yearRange === 'any') {
				...
				selector += '</select><span style="width: auto; padding:0; display: inline;">年</span> ';
			}
            var selector2='<span style="width: auto; padding:0; display: inline-block; line-height: 32px; font-size: 16px;"><i id="nowyear">'+year+'</i>年</span>';
			html = html.replace(/\\x2F/, selector2);
			return html;
		},
